    ...
    public class TeacherServices
    {
        ...
        public int AddExam(int teachid, string examname)
        {
           ...
           // var sql = "INSERT INTO Exams (TeacherId, ExamName) VALUES (@teachId, @Examname)";
            ...
            using (var connection = new SqlConnection("User Id=postgres;Password=e6LRa*%Gbb_Xqay;Server=db.pofymtwwmjfurydaqnhg.supabase.co;Port=5432;Database=postgres"))
            {
